<?php
/**
 * O modelo para exibir páginas da categoria personalizada
 *
    ...
    <div class="container">
        <div class="row box-contet">
            <section class="col-sm-8 ">
                <div class="col-sm-12">
                    <header>
                        <h3>RESULTADOS PARA Fotos<strong> <?php echo the_category_exclude(", ", "destaque"); ?></strong> </h3>
                    </header>
                ...
                <!--Previl post-->
                <?php
                $args = array('post_type' => 'galerias', 'posts_per_page' => 10);
                $loop = new WP_Query($args);

                if (have_posts()) : while ($loop->have_posts()) : $loop->the_post();
                        get_template_part('template-part/post-categorys-fotos');
                    endwhile;
                    wp_pagenavi();
                else :
